<%-- 
    Document   : Usuarios
    Created on : 27/10/2015, 09:10:28 AM
    Author     : bmunoz
--%>
...
<html>
    <head>
        <meta http-equiv="Content-Type" content="text/html; charset=UTF-8">
         ...
         <link rel="stylesheet" type="text/css" href="recursos/css/usuarios.css" />
        ...
        <script type="text/javascript" src="recursos/js/usuarios.js"></script>
