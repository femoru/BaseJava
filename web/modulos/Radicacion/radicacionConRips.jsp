...
<html>
    <head>
        ...
        <link rel="stylesheet" type="text/css" href="recursos/css/radicacionConRips.css" />
       ...
       <script type="text/javascript" src="recursos/terceros/momentjs/momentjs.min.js"></script>
        ...
        <!-- <script type="text/javascript" src="recursos/terceros/momentjs/moment_es.js"></script>-->
